...
fn gen_impl_block(
    ...
    let where_clause = match &generics.deps {
        generics::Deps::Generic {
            ...
            if !trait_bounds.is_empty() {
                let impl_path = idents.impl_path(span);
                where_clause.push_impl_predicate(parse_quote! {
                    #impl_path: #(#trait_bounds)+*
                });
            }

            let impl_t = &idents.impl_t;
        ...
        generics::Deps::Concrete(_) => {
            ...
            generics.where_clause_generator()
        }
    };
...
struct SelfTy<'g>(&'g generics::Generics, proc_macro2::Span);
