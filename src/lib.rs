...
//! # use entrait::*;
//!
//! struct App { something: i32 };
//!
//! #[entrait(Generic)]
//! fn generic(deps: &impl Concrete) -> i32 {
//!     deps.concrete()
//! }
//!
//! #[entrait(Concrete)]
//! fn concrete(app: &App) -> i32 {
//!     app.something
//! }
//!
...
#[cfg(all(feature = "mockall", feature = "unimock"))]
mod macros {
    pub use entrait_macros::entrait_export_unimock_mockall as entrait_export;
    pub use entrait_macros::entrait_unimock_mockall as entrait;
}

#[cfg(all(feature = "unimock", not(feature = "mockall")))]
mod macros {
    pub use entrait_macros::entrait_export_unimock as entrait_export;
    pub use entrait_macros::entrait_unimock as entrait;
}

#[cfg(all(not(feature = "unimock"), feature = "mockall"))]
mod macros {
    pub use entrait_macros::entrait_export_mockall as entrait_export;
    pub use entrait_macros::entrait_mockall as entrait;
}

#[cfg(all(not(feature = "unimock"), not(feature = "mockall")))]
mod macros {
